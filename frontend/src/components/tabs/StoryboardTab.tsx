      ...
      <div className="flex items-center justify-between border-b border-slate-200 bg-white p-4">
        <div className="flex items-center space-x-4">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-sm text-slate-500">共 {scenes.length} 个场景</span>
          </div>
          <button
            onClick={toggleAllScenes}
            className="flex items-center space-x-2 rounded-lg bg-blue-50 px-3 py-2 text-sm font-medium text-blue-700 transition-colors hover:bg-blue-100"
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className="flex w-full items-center justify-between bg-gradient-to-r from-blue-50 to-purple-50 px-6 py-4 transition-colors hover:from-blue-100 hover:to-purple-100"
                >
                ...
                {sceneExpanded && (
                  <div className="border-t border-slate-200">
                    ...
                    <div className="flex items-center justify-between border-b border-slate-100 bg-slate-50 px-6 py-2">
                      <span className="text-sm text-slate-600">{scene.shots.length} 个镜头</span>
                      <button
                        onClick={() => toggleAllShotsInScene(scene.scene_number)}
                        className="flex items-center space-x-1 rounded bg-purple-50 px-2 py-1 text-xs font-medium text-purple-700 transition-colors hover:bg-purple-100"
                        title={
                          scene.shots.every((shot) =>
                            expandedShots.has(`${scene.scene_number}-${shot.shot_number}`)
                          )
                            ? '折叠所有镜头'
                            : '展开所有镜头'
                        }
                      ...
                      return (
                        <div key={shotKey} className="border-b border-slate-100 last:border-0">
                          ...
                          <button
                            ...
                            className="flex w-full items-center justify-between px-8 py-3 transition-colors hover:bg-slate-50"
                          >
                            <div className="flex items-center space-x-3">
                              {shotExpanded ? (
                          ...
                          {/* 子镜头列表 */}
                          {shotExpanded && (
                            <div className="space-y-3 bg-slate-50 px-12 py-4">
                              {shot.subShots.map((subShot) => (
                                ...
                                >
                                  <div className="mb-3 flex items-start space-x-3">
                                    <ImageIcon className="mt-1 h-4 w-4 text-pink-600" />
