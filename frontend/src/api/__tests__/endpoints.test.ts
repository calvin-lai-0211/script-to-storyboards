...
describe('API Endpoints', () => {
  describe('Character endpoints', () => {
    it('should generate correct character URL', () => {
      expect(API_ENDPOINTS.getCharacter(123)).toBe(`${API_BASE_URL}/api/character/123`)
      expect(API_ENDPOINTS.getCharacter('abc')).toBe(`${API_BASE_URL}/api/character/abc`)
    })
  ...
  describe('Characters list endpoints', () => {
    it('should generate correct get all characters URL', () => {
      expect(API_ENDPOINTS.getAllCharacters()).toBe(`${API_BASE_URL}/api/characters/all`)
    })

    it('should generate correct get characters URL with encoding', () => {
      const key = '剧本名'
      const encoded = encodeURIComponent(key)
      expect(API_ENDPOINTS.getCharacters(key)).toBe(`${API_BASE_URL}/api/characters/${encoded}`)
    })

    it('should generate correct generate characters URL', () => {
      expect(API_ENDPOINTS.generateCharacters()).toBe(`${API_BASE_URL}/api/characters/generate`)
    })
  })

  describe('Scenes endpoints', () => {
    it('should generate correct get all scenes URL', () => {
      expect(API_ENDPOINTS.getAllScenes()).toBe(`${API_BASE_URL}/api/scenes/all`)
    })
    ...
    it('should generate correct generate scenes URL', () => {
      expect(API_ENDPOINTS.generateScenes()).toBe(`${API_BASE_URL}/api/scenes/generate`)
    })
  })
  ...
  describe('Props endpoints', () => {
    ...
    it('should generate correct generate props URL', () => {
      expect(API_ENDPOINTS.generateProps()).toBe(`${API_BASE_URL}/api/props/generate`)
    })
  })
  ...
  describe('Scripts endpoints', () => {
    ...
    it('should handle special characters in script key', () => {
      const key = '剧本/第1集'
      const encoded = encodeURIComponent(key)
      expect(API_ENDPOINTS.getScript(key)).toBe(`${API_BASE_URL}/api/scripts/${encoded}`)
    })
  })

  describe('Storyboards endpoints', () => {
    it('should generate correct storyboard URL', () => {
      expect(API_ENDPOINTS.generateStoryboard()).toBe(`${API_BASE_URL}/api/storyboard/generate`)
    })
  ...
  describe('Memory endpoints', () => {
    ...
    it('should handle UUID keys', () => {
      ...
      expect(API_ENDPOINTS.getEpisodeMemory(key)).toBe(`${API_BASE_URL}/api/memory/${key}`)
    })
  })
